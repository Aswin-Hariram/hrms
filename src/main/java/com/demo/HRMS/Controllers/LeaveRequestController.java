...
public class LeaveRequestController {
    ...
    public ResponseEntity<?> getRequestedLeaves(Authentication authentication){
        ...
        Map<String,Object> response = leaveRequestService.getAllLeaveRequests(empID,orgID);
        return ResponseEntity.ok(response);
    }

    @PreAuthorize("hasAnyRole('HR','SUPER_ADMIN')")
    @PostMapping("/approve")
    public ResponseEntity<?> approveRequestedLeave(@RequestParam Long reqId, Authentication authentication){
        ...
        Map<String,Object> response = leaveRequestService.approveLeave(reqId,hrId,orgID);
        return ResponseEntity.ok(response);
    }
}
